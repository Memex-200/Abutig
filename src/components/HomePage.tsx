...
import { FileText, Users, BarChart3, Shield, Clock, CheckCircle, AlertCircle, Phone } from 'lucide-react';
...
const HomePage: React.FC<HomePageProps> = ({ onNavigate }) => {
  ...
  const complaintTypes = [
    { icon: '🏚️', name: 'شكوى بناء مخالف', description: 'بناء بدون ترخيص أو مخالف للقوانين' },
    { icon: '🚽', name: 'شكوى صرف صحي', description: 'مشاكل في شبكة الصرف الصحي' },
    { icon: '♻️', name: 'شكوى نظافة أو قمامة', description: 'تراكم القمامة أو عدم النظافة' },
    { icon: '🚧', name: 'شكوى طريق أو رصف', description: 'تلف في الطرق أو الأرصفة' },
    { icon: '💡', name: 'شكوى إنارة', description: 'مشاكل في الإنارة العامة' },
    { icon: '📶', name: 'شكوى ضعف الإنترنت', description: 'ضعف أو انقطاع الإنترنت' }
  ];

  const stats = [
    { number: '1,234', label: 'شكوى تم حلها', icon: CheckCircle, color: 'text-green-600' },
    { number: '89', label: 'شكوى قيد المعالجة', icon: AlertCircle, color: 'text-orange-600' },
    { number: '45', label: 'شكوى جديدة', icon: FileText, color: 'text-blue-600' },
    { number: '24/7', label: 'خدمة على مدار الساعة', icon: Clock, color: 'text-purple-600' }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg mb-12 max-w-3xl mx-auto text-blue-50">
              ...
              فريقنا المتخصص جاهز لخدمتك على مدار الساعة لضمان حل جميع المشاكل بسرعة وكفاءة.
            </p>
